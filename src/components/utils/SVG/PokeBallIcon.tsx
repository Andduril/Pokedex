const PokeBallIcon = () => {
  return (
        <svg version="1.1" id="Pokéball" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            ...
            <g id="Pokéball_1_">
                <g id="Colours">
                    ...
                    <path id="Up" fill="#FF1C1C" d="M297.7,213.2c40.4,0,74.1,28.6,82.1,66.6h134.4C504.7,169.2,412,82.5,299,82.5S93.4,169.2,83.9,279.7 h131.7C223.6,241.7,257.3,213.2,297.7,213.2z"/>
